...
"externalAdReply": {
                ...
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://IMG-20211124-WA0254.jpg",
                "thumbnail": fake,
                "sourceUrl": ``
...
"externalAdReply": {
                ...
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/IMG-20211124-WA0254.jpg",
                "thumbnail": iye,
    ...
    if (!mek.key.remoteJid.endsWith("@g.us") && offline) {
      if (!mek.key.fromMe) {
        ...
        xeon.sendMessage(
          ...
          {
            contextInfo: {
              mentionedJid: [`${owner}@wa.me/919745310120`],
...
`
sendButLocation(from, `${menu}`,`ʙᴏᴛ ʙʏ @${wa.me/919745310120("@")[0]}`, {jpegThumbnail:iye}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`credit`,buttonText:{displayText:'THANKS TO'},type:1},{buttonId:`script`,buttonText:{displayText:'SCRIPT'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
...
│
│  ❑ *ɢɪᴛʜᴜʙ ʟɪɴᴋ* :
│  https://github.com/rafhanser/RAFHAN-SER
│  
│
│ 
│
